...
namespace ISPoliceAppApi.Migrations
{
    ...
    [Migration("20220705081109_ChangeNoteControllerAndModeltoAllegationControllerAndModel")]
    partial class ChangeNoteControllerAndModeltoAllegationControllerAndModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.AllegationEnquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AllegationId");

                    b.ToTable("Enquiries");
                });

            modelBuilder.Entity("ISPoliceAppApi.Models.AllegationEnquiryDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AllegationEnquiryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AllegationEnquiryId");

                    b.ToTable("AllegationEnquiryDocuments");
                });

            modelBuilder.Entity("ISPoliceAppApi.Models.AllegationNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.Memorandum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.PersonnelChildren", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.PersonnelSpouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.AllegationEnquiry", b =>
                {
                    b.HasOne("ISPoliceAppApi.Models.Allegation", "Allegation")
                        .WithMany()
                        .HasForeignKey("AllegationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.AllegationEnquiryDocument", b =>
                {
                    b.HasOne("ISPoliceAppApi.Models.AllegationEnquiry", "AllegationEnquiry")
                        .WithMany("AllegationEnquiryDocuments")
                        .HasForeignKey("AllegationEnquiryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

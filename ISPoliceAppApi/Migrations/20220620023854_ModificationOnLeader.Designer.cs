...
namespace ISPoliceAppApi.Migrations
{
    ...
    [Migration("20220620023854_ModificationOnLeader")]
    partial class ModificationOnLeader
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISPoliceAppApi.Models.Leader", b =>
                {
                    b.HasOne("ISPoliceAppApi.Models.Gender", "LeaderGender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ISPoliceAppApi.Models.LeadersGroup", "Leaders")
                        .WithMany()
                        .HasForeignKey("LeadersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ISPoliceAppApi.Models.MaritalStatus", "LeaderMaritalStatus")
                        .WithMany()
                        .HasForeignKey("MaritalStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ISPoliceAppApi.Models.Religion", "leaderReligion")
                        .WithMany()
